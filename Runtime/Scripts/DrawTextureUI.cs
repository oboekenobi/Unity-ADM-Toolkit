...
public class DrawTextureUI : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        uI_Manager.m_penLayout?.RegisterCallback<PointerMoveEvent>(Draw);
        ...
        divRect = Vector2.one / screenSize;
    ...
    private void Draw(PointerMoveEvent evt)
    {
        pointerCaptured = evt.dispatch;
    }
    private void Update()
    {
